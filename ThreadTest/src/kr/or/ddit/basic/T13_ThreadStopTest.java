...
class ThreadStopEx1 extends Thread {
	...
	public void run() {
		while(!stop) {
			System.out.println("쓰레드 처리중...Ex1");
		}
...
//		try {
//			while(true) {
//				System.out.println(" 쓰레드 처리 중 Ex2");
//				Thread.sleep(1);
//			}
//		}
//		catch (InterruptedException e) { }
		...
		// 방법 2
		// interrupt() 메서드가 호출 되었는지 검사하기
		while(true) {
			System.out.println("쓰레드 처리중...Ex1");
			
//			// 검사방법1 -> 쓰레드의 인스턴스 용 메서드를 이용하는 방법
...
//			}
			...
			if(Thread.interrupted())	// interrupted() 메서드 호출되면 true
			{
