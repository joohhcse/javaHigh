 ...
 *  전체 합계를 구하는 작업을 단독으로 했을때(1개의 쓰레드를 사용했을때)와 여러 쓰레드로 분할해서 작업할 때의
 *  시간을 확인해보자
 */
	...
	public static void main(String[] args) {
		...
		System.out.println("단독으로 처리할 대의 처리시간 : " + (endTime - startTime));
		System.out.println("\n\n");
		...
		System.out.println("협력 처리 했을 대의 처리시간 : " + (endTime - startTime));
