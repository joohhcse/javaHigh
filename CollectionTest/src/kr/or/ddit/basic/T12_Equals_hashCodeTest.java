...
public class T12_Equals_hashCodeTest {
	 ...
	 *  
	 *  - equals()메서드는 hashCode() 메서드에 관련된 규칙 
	 ...
	 *  하지만 두 객체가 같다면 반드시 hashCode가 같아야한다.
	 *  4. equals() 메서드를 override하면 반드시 hashCode() 메서드도 override해야 한다.
	 *  5. hashCode()는 기본적으로 Heap 에 있는 각 객체에 대한 메모리 주소 매핑정보를 기반으로 한 정수값을 반환한다.
	 ...
	 *   그래서 객체가 같지 않더라도 hashCode가 같은수 있다.
	 * 
	*/
