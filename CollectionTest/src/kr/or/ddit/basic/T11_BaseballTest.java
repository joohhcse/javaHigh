...
//	public static void main(String[] args) {
//		
//		Set ball = new TreeSet();
//		
//		for( int i = 0 ; ball.size() < 3 ; i++)
//		{
...
//		}
//		
//		List<Integer> intBallList = new ArrayList<Integer>(ball);
//
//		int iStrike = 0;
//		int iBall = 0;
//		
//		//Strike check
//		for(int i = 0 ; i < intBallList.size() ; i++)
//		{
//			if( input[i] == intBallList.get(i))
//				iStrike++;
//			
//			if( i == 0)
//			{
//				if( input[i] == intBallList.get(i+1))
//					iBall++;
//				if( input[i] == intBallList.get(i+2))
//					iBall++;
//			}
//			else if( i == 1)
//			{
...
//		}
//		
//		System.out.printf("%dS %dB", iStrike, iBall);
//		
//		
//		
//		
