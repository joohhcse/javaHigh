...
public class T01_FileTest {
	public static void main(String[] args) {
		...
		// => 디렉토리와 디렉터리 사이 또는 디렉토리와 파일명 사이의 구분문자는 
		//	  '\'를 사용하거나 '/'를 사용할 수 있다.
		File file = new File("e:\\E_Other\\test.txt");
		...
		//File file2 = new File("e:/E_Other/test.txt");
		...
		File file4 = new File("\\E_Other\\test..", "test.txt");
		...
		File file6 = new File("e:/E_Other/test/java/src");
		if(file6.mkdirs()) {
