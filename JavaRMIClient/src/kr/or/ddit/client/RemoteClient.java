...
//			files[1] = new File("e:/D_Other/Hydrageas.jpg");
			files[0] = new File("e:/D_Other/sibadog.gif");
			files[1] = new File("e:/D_Other/sibadog2.gif");
			...
			clientInf.setFiles(fInfo); // 서버의 파일 저장하는메서드 호출
